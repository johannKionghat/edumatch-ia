...
l'axiome d'efficacité, qui dit que la somme des contributions doit
retrouver toute la prédiction, à une précision de dix puissance moins quinze
...
J'ai écrit, avant toute nouvelle mesure, ce qui me ferait changer d'avis
sur le modèle : passer sous les deux erreurs de la
